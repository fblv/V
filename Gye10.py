...
acil = LINETCR.LINE()
acil.login(token="ISI TOKET AKUN UTAMA EH SALAH TOKEN MAKSUDNYA")
acil.loginResult()
ki = PRANKBOTS.LINE()
ki.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki.loginResult()
ki2= PRANKBOTS.LINE()
ki2.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki2.loginResult()
ki3 = PRANKBOTS.LINE()
ki3.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki3.loginResult()
ki4 = PRANKBOTS.LINE()
ki4.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki4.loginResult()
ki5 = PRANKBOTS.LINE()
ki5.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki5.loginResult()
ki6 = PRANKBOTS.LINE()
ki6.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki6.loginResult()
ki7 = PRANKBOTS.LINE()
ki7.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki7.loginResult()
ki8 = PRANKBOTS.LINE()
ki8.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki8.loginResult()
ki9 = PRANKBOTS.LINE()
ki9.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki9.loginResult()
ki10 = PRANKBOTS.LINE()
ki10.login(token="Toketnya Taro Sini Bro Eh Token Maksudnya")
ki10.loginResult()
print "GyeVha Sucsses Login\nJangan Sombong Bos\nSelama Menggunakan Sc Orang"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage="""(🇲🇨GYEVHABOTH🇲🇨)
╔══════════════╗
    🇲🇨GYEVHABOTH🇲🇨
╚══════════════╝
╔══════════════╗
...
admsa = "u8e99954d0cf94cd7708d6eda519d477b"
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'message':"""Haiii Thanks Sudah Add Salam Kenalll 🇲🇨GyeVha🇲🇨""",
    "lang":"JP",
    "comment":"I Like It  🇲🇨GyeVha-Both🇲🇨",
    "comment1":"I Like It  🇲🇨GyeVha-Both🇲🇨",
    "commentOn":False,
    "likeOn":True,
    "wcOn":True,
    "leftOn":True,
